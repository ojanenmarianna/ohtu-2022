...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.luku_kuuluu_joukkoon(11))

        joukko.poista_luku(11)

        self.assertFalse(joukko.luku_kuuluu_joukkoon(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.luku_kuuluu_joukkoon(10))
        self.assertFalse(self.joukko.luku_kuuluu_joukkoon(5))
        self.assertTrue(self.joukko.luku_kuuluu_joukkoon(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista_luku(3)
        self.assertFalse(self.joukko.luku_kuuluu_joukkoon(3))
